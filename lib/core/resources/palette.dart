...
class Palette {
  ...
  static const Color mainColor = Color(0xff2A2C24);
  static const Color secondColor = Color(0xff575A4B);
  static const Color disabledButtonColor = Color(0xff816C61);
  static const Color pinkColor = Color(0xffB9D8C2);
  static const Color blueColor = Color(0xff456FFF);
  static const Color greyColor = Color(0xff9C95AD);
  static const Color emptyColor = Color(0xff4A5043);
  static const Color redColor = Color(0xff9AC2C9);
  static const Color greenColor = Color(0xff2FDA9C);
  static const Color orangeColor = Color(0xffFD9B00);
}
